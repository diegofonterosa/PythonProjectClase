...
numero_entero1 = 45
numero_entero2 = 37
print("La suma de los números enteros es:", numero_entero1 + numero_entero2)

# Ejercicio número flotante
numero_flotante = 34.56
print("El resultado de la división del número flotante es:", numero_flotante / 3)
